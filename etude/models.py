...
class Intervenant(models.Model):
    ...
    partie1 = models.IntegerField(default=0)
    partie2 = models.IntegerField(default=0)
    partie3 = models.IntegerField(default=0)
    partie4 = models.IntegerField(default=0)
    partie5 = models.IntegerField(default=0)
    partie6 = models.IntegerField(default=0)
